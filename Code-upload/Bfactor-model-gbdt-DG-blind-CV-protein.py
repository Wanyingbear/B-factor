...
def main(args):
    ...
    magnitude_feature_path = f"{main_dir}/features/magnitude_filtered_CV"
    X_train_all = []
    ...
    for pdbid in list_PDBs_test:
        ...
        X_test.append(pd.read_csv(save_path, header=None).values)  
    ...
    for pdbid in list_PDBs_train:
        ...
        laebl_pdb = pd.read_csv(label_path, header=None, index_col=None).values
        labels_train.append(laebl_pdb)
